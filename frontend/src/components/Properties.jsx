...
const Properties = () => {
  const [
    ...
    setContactsllerssuccessMessage,
  ] = useState("");
  ...
  const [propertiesPerPage,setPropertiesPerPage] = useState(6); // Set how many properties per page
  ...
  const handleFavoriteClick = async (propertyId) => {
    try {
      const response = await axios.post(
        `${API_BASE_URL}/favorite_property/`,
        {
          propertyId,
        },
        {
      ...
      if (response.status === 201) {
        ...
        Swal.fire({
          title: "Favorited!",
          html:
            '<span style="font-size: 100px;" >💚</span> <br/> Property added to your favorite list!',
          icon: "success",
        ...
        Swal.fire({
          title: "",
          html:
            '<span style="font-size: 100px;" >❤️</span> <br/> Property alredy in your favorite list!',
          icon: "warning",
  ...
  const prevPage = () => currentPage > 1 && setCurrentPage(currentPage - 1);
    ...
    const handlePropertiesPerPageChange = (event) => {
        const newValue = parseInt(event.target.getAttribute("data-value"), 10);
        setPropertiesPerPage(newValue);
          ...
          <div className="box-title-listing">
            ...
            <div className="box-filter-tab">
              ...
              <div className="nice-select list-page" tabIndex="0">
                <span className="current">{propertiesPerPage} Per Page</span>
                <ul className="list">
                  <li
                    data-value="10"
                    className={`option ${
                      propertiesPerPage === 10 ? "selected" : ""
                    }`}
                    onClick={handlePropertiesPerPageChange}
                  >
                    10 Per Page
                  </li>
                  <li
